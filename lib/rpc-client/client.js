...
pro.start = function (cb) {
  ...
  this._station.start(function (err) {
    if (err) {
      logger.error('[pomelo-rpc] client start fail ',{stack:err.stack});
      return cb(err);
    }
